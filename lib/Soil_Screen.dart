...
class _SoilPageState extends State<SoilPage> {
  ...
  Future<void> _classifyImage(File image) async {
    final request = http.MultipartRequest(
        'POST', Uri.parse('http://192.168.1.3:5000/soil'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Soil Compatability',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),backgroundColor: Color.fromARGB(255, 6, 104, 57),
      ),
      body: Container(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text('Soil Suitable For:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                              SizedBox(height: 5),
                              Text('${_result!['soil_rec']}', style: TextStyle(color: Colors.white),),
                            ],
                          ),
                        ),
                      ],
